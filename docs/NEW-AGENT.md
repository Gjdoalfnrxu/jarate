...
- [ ] A Discord channel for the agent (id, e.g. `1548547729272344717`).
...
Fleet convention: password `phishasu` (same as the andryo sudo chain).
...
```json
{
  ...
  "channels": [{
    ...
    "botToken": "<bot-token>",
    "default": true,
    "ownerUserId": "108801968763305984",
